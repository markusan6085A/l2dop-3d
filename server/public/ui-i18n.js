...
(function (global) {
  ...
  L2.UI = {
    ...
    nav_profile: { uk: 'Профіль', ru: 'Профиль' },
    nav_profile_title: {
      uk: 'Профіль · стати й характеристики',
      ru: 'Профиль · статы и характеристики',
    },
    ...
    auth_login_title: { uk: 'Вхід', ru: 'Вход' },
    auth_login_desc: {
    ...
    magisters_h1: {
      uk: 'Магістри та наставники',
      ru: 'Магистры и наставники',
    },
    magisters_hint: {
      uk:
        'Як у l2dop: кнопка «Магістри» в місті → лише НПС, у яких є навчання умінь (магістр, префект, пророк тощо). Далі обираєш наставника й дію.',
      ru:
        'Как в l2dop: кнопка «Магистры» в городе → только NPC, у которых есть обучение умений (магистр, префект, пророк и т.д.). Дальше выбираешь наставника и действие.',
    },
