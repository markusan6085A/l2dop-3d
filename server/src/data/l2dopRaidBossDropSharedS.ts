...
export const RB_DROP_ITEM_S = {
  ...
  angelSlayer: item(20167, 'Angel Slayer', `${Ws}/angel_slayer.jpg`),
  arcanaMace: item(20170, 'Arcana Mace', `${Ws}/arcana_mace.jpg`),
  baguettesDualsword: item(910202, "Baguette's Dualsword", `${Ws}/baguette_s_dualsword.jpg`),
  basaltBattlehammer: item(20168, 'Basalt Battlehammer', `${Ws}/basalt_battlehammer.jpg`),
  demonSplinter: item(20172, 'Demon Splinter', `${Ws}/demon_splinter.jpg`),
  draconicBow: item(20173, 'Draconic Bow', `${Ws}/draconic_bow.jpg`),
  dragonHunterAxe: item(20169, 'Dragon Hunter Axe', `${Ws}/dragon_hunter_axe.jpg`),
  godsBlade: item(82, "God's Blade", `${Ws}/god_s_blade.jpg`),
  heavensDivider: item(20166, "Heaven's Divider", `${Ws}/heaven_s_divider.jpg`),
  imperialStaff: item(20171, 'Imperial Staff', `${Ws}/imperial_staff.jpg`),
  saintSpear: item(20174, 'Saint Spear', `${Ws}/saint_spear.jpg`),
  shiningBow: item(910203, 'Shining Bow', `${Ws}/shining_bow.jpg`),
