...
export const RB_DROP_ITEM_A = {
  ...
  soulBow: item(7575, 'Soul Bow', `${Wa}/soul_bow.jpg`),
  ...
  swordOfMiracles: item(88, 'Sword of Miracles', `${Wa}/sword_of_miracles.jpg`),
  ...
  darkCrystalBoots: item(563, 'Dark Crystal Boots', `${Aa}/dark_crystal_boots.jpg`),
  darkCrystalGloves: item(2472, 'Dark Crystal Glove', `${Aa}/dark_crystal_glove.jpg`),
  darkCrystalShield: item(641, 'Dark Crystal Shield I00 0', `${Aa}/shield_dark_crystal_shield_i00_0.jpg`),
  shieldOfNightmare: item(2498, 'Shield Of Nightmare I00 0', `${Aa}/shield_shield_of_nightmare_i00_0.jpg`),
  ...
  majesticBoots: item(583, 'Majestic Boots', `${Aa}/majestic_boots.jpg`),
  majesticGauntlets: item(2482, 'Majestic Gauntlets', `${Aa}/majestic_gauntlets.jpg`),
