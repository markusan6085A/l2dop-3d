...
export const RB_DROP_ITEM_B = {
  apprenticesSpellbook: item(910101, "Apprentice's Spellbook", `${Wb}/apprentices_spellbook.jpg`),
  artOfBattleAxe: item(175, 'Art of Battle Axe', `${Wb}/art_of_battle_axe.jpg`),
  baguettesDualsword: item(910102, "Baguette's Dualsword", `${Wb}/baguette_s_dualsword.jpg`),
  bowOfPeril: item(287, 'Bow of Peril', `${Wb}/bow_of_peril.jpg`),
  darkElvenLongBow: item(284, 'Dark Elven Long Bow', `${Wb}/dark_elven_long_bow.jpg`),
  deadmansGlory: item(171, "Deadman's Glory", `${Wb}/deadman_s_glory.jpg`),
  greatAxe: item(300, 'Great Axe', `${Wb}/great_axe.jpg`),
  greatSword: item(78, 'Great Sword', `${Wb}/great_sword.jpg`),
  guardianSword: item(7883, 'Guardian Sword', `${Wb}/guardian_sword.jpg`),
  hellKnife: item(243, 'Hell Knife', `${Wb}/hell_knife.jpg`),
  iceStormHammer: item(7900, 'Ice Storm Hammer', `${Wb}/ice_storm_hammer.jpg`),
  kaimVanulsBones: item(7893, "Kaim Vanul's Bones", `${Wb}/kaim_vanul_s_bones.jpg`),
  kris: item(229, 'Kris', `${Wb}/kris.jpg`),
  lance: item(97, 'Lance', `${Wb}/lance.jpg`),
  spellBreaker: item(7892, 'Spell Breaker', `${Wb}/spell_breaker.jpg`),
  spiritsStaff: item(92, "Sprite's Staff", `${Wb}/spirit_s_staff.jpg`),
  staffOfEvilSpirits: item(210, 'Staff of Evil Spirits', `${Wb}/staff_of_evil_spirits.jpg`),
  starBuster: item(7901, 'Star Buster', `${Wb}/star_buster.jpg`),
  swordOfDamascus: item(79, 'Sword of Damascus', `${Wb}/sword_of_damascus.jpg`),
  swordOfValhalla: item(148, 'Sword of Valhalla', `${Wb}/sword_of_valhalla.jpg`),
  wizardsTear: item(7889, "Wizard's Tear", `${Wb}/wizard_s_tear.jpg`),
  arthroNail: item(267, 'Arthro Nail', `${Wb}/arthro_nail.jpg`),
  bellionCestus: item(268, 'Bellion Cestus', `${Wb}/bellion_cestus.jpg`),
