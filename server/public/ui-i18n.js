...
(function (global) {
  ...
  L2.UI = {
    ...
    clan_my_leader: { uk: 'Лідер клану:', ru: 'Лидер клана:' },
    clan_my_not_in_clan: { uk: 'Ти ще не в клані.', ru: 'Ты ещё не в клане.' },
    clan_my_label_clan: { uk: 'Клан:', ru: 'Клан:' },
    clan_my_label_founded: { uk: 'Заснований:', ru: 'Основан:' },
    clan_my_label_level: { uk: 'Рівень:', ru: 'Уровень:' },
    clan_my_label_announce: { uk: 'Оголошення:', ru: 'Объявление:' },
    clan_my_label_reputation: { uk: 'Репутація:', ru: 'Репутация:' },
    clan_my_label_rating: { uk: 'Рейтинг:', ru: 'Рейтинг:' },
    clan_my_label_skill_pts: { uk: 'Очки вмінь:', ru: 'Очки умений:' },
    clan_my_label_adena: { uk: 'Адена:', ru: 'Адена:' },
    clan_my_label_luck: { uk: 'Монет Удачі:', ru: 'Монет Удачи:' },
    clan_my_label_warehouse: { uk: 'Склад:', ru: 'Склад:' },
    clan_my_link_deposit: { uk: 'поповнити', ru: 'пополнить' },
    clan_my_link_withdraw: { uk: 'взяти', ru: 'взять' },
    clan_my_link_history: { uk: 'Історія клану', ru: 'История клана' },
    clan_my_link_members: { uk: 'Учасники:', ru: 'Участники:' },
    clan_my_link_wh_deposit: { uk: 'покласти речі', ru: 'положить вещи' },
    clan_my_link_wh_withdraw: { uk: 'взяти', ru: 'взять' },
    clan_my_nav_quests: { uk: 'Кланові завдання', ru: 'Клановые задания' },
    clan_my_nav_castles: { uk: 'Замки клану', ru: 'Замки клана' },
    ...
    clan_my_leave_confirm_q: {
      uk: 'Ви впевнені що хочете вийти з клану',
      ru: 'Вы уверены что хотите выйти из клана',
    },
    clan_my_leave_yes: { uk: 'Так', ru: 'Да' },
    clan_my_leave_no: { uk: 'Ні', ru: 'Нет' },
    clan_my_announce_ph: {
      uk: 'Напиши оголошення для клану…',
      ru: 'Напиши объявление для клана…',
    },
    clan_my_announce_submit: { uk: 'Написати', ru: 'Написать' },
    clan_my_manage_btn: { uk: 'Керування кланом', ru: 'Управление кланом' },
    page_clan_manage_title: { uk: 'Керування кланом — L2WAP', ru: 'Управление кланом — L2WAP' },
    clan_manage_section_aria: { uk: 'Керування кланом', ru: 'Управление кланом' },
    clan_manage_title: { uk: 'Керування кланом', ru: 'Управление кланом' },
    clan_manage_back_my: { uk: '<< Назад до мого клану', ru: '<< Назад к моему клану' },
    clan_manage_invite: { uk: 'Запросити в клан', ru: 'Пригласить в клан' },
    clan_manage_requests: { uk: 'Заявки в клан', ru: 'Заявки в клан' },
    clan_manage_kick: { uk: 'Вигнати учасника', ru: 'Изгнать участника' },
    clan_manage_ranks: { uk: 'Ранги учасників', ru: 'Ранги участников' },
    clan_manage_disband: { uk: 'Розпустити клан', ru: 'Распустить клан' },
    clan_manage_stub_invite: { uk: 'Запросити в клан', ru: 'Пригласить в клан' },
    clan_manage_stub_requests: { uk: 'Заявки в клан', ru: 'Заявки в клан' },
    clan_manage_stub_kick: { uk: 'Вигнати учасника', ru: 'Изгнать участника' },
    clan_manage_stub_ranks: { uk: 'Ранги учасників', ru: 'Ранги участников' },
    clan_manage_stub_disband: { uk: 'Розпустити клан', ru: 'Распустить клан' },
    page_clan_hall_title: { uk: 'КланХолл — L2WAP', ru: 'КланХолл — L2WAP' },
    clan_hall_section_aria: { uk: 'КланХолл', ru: 'КланХолл' },
    clan_hall_title: { uk: 'КланХолл', ru: 'КланХолл' },
    clan_hall_desc: {
      uk: 'Клан-хол надає всім учасникам клану постійне благословення.',
      ru: 'Клан-холл даёт всем участникам клана постоянное благословение.',
    },
    clan_hall_back_my: { uk: '<< Назад до мого клану', ru: '<< Назад к моему клану' },
    clan_hall_offer: {
      uk: '«Благословення Клан-холу». Ціна 1:Adena',
      ru: '«Благословение Клан-холла». Цена 1:Adena',
    },
    clan_hall_buy: { uk: '[Купити]', ru: '[Купить]' },
    clan_hall_apply_buff: { uk: 'Накласти баф', ru: 'Наложить баф' },
    clan_hall_col_level: { uk: 'Рівень клану', ru: 'Уровень клана' },
    clan_hall_col_patk: { uk: 'Фіз. атака', ru: 'Физ. атака' },
    clan_hall_col_matk: { uk: 'Маг. атака', ru: 'Маг. атака' },
    clan_hall_col_pdef: { uk: 'Фіз. захист', ru: 'Физ. защита' },
    clan_hall_col_mdef: { uk: 'Маг. захист', ru: 'Маг. защита' },
    clan_hall_col_hp: { uk: 'Макс. HP', ru: 'Макс. HP' },
    clan_my_rating_place: { uk: 'місце', ru: 'место' },
    clan_my_members_of: { uk: 'із', ru: 'из' },
    clan_my_stub_deposit_adena: { uk: 'поповнити (адена)', ru: 'пополнить (адена)' },
    clan_my_stub_withdraw_adena: { uk: 'взяти (адена)', ru: 'взять (адена)' },
    clan_my_stub_deposit_luck: { uk: 'поповнити (монети)', ru: 'пополнить (монеты)' },
    clan_my_stub_withdraw_luck: { uk: 'взяти (монети)', ru: 'взять (монеты)' },
    clan_my_stub_history: { uk: 'Історія клану', ru: 'История клана' },
    clan_my_stub_members: { uk: 'Учасники', ru: 'Участники' },
    clan_my_stub_wh_deposit: { uk: 'покласти речі', ru: 'положить вещи' },
    clan_my_stub_wh_withdraw: { uk: 'взяти зі складу', ru: 'взять со склада' },
    clan_my_stub_quests: { uk: 'Кланові завдання', ru: 'Клановые задания' },
    clan_my_stub_castles: { uk: 'Замки клану', ru: 'Замки клана' },
    clan_my_stub_dungeons: { uk: 'Підземелля драконів', ru: 'Подземелья драконов' },
    clan_my_stub_hall: { uk: 'КланХолл', ru: 'КланХолл' },
