...
/** Interlude `activateRate` для Thunder Storm (skill 48). */
export const THUNDER_STORM_BASE_STUN_CHANCE_PCT = 50;
export const THUNDER_STORM_STUN_PER_RANK_PCT = 0;
export const THUNDER_STORM_STUN_CHANCE_CAP_PCT = 50;
