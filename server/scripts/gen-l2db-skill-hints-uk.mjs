...
const MANUAL_HINT_OVERRIDES_UK = {
  ...
  227: 'Пасив: підвищує P. Def (%) і ухилення в легкій броні (1 р. — +4.2% / +3 ухил., 50 р. — +81.3% / +6).',
  216: 'Пасив: підвищує P. Atk (flat) зі списом або алебардою (1 р. — +4.5, 43 р. — +122.1).',
  257: 'Пасив: підвищує P. Atk (flat) з мечем або булавою (1 р. — +4.5, 43 р. — +122.1).',
  255: 'Актив: потужний удар по одній цілі. Лише меч або булава (1 р. — MP 22 / power 90, 15 р. — MP 37 / power 326). Можливий надудар.',
  100: 'Актив: урон + оглушення по одній цілі. Лише булава (1 р. — MP 20 / power 36, 15 р. — MP 34 / power 131). Повторне оглушення не накладається, поки діє ефект. Можливий надудар.',
  312: 'Toggle (не аура): крит / сила криту, поки увімкнено. MP ~0.4/с. 1 р. — +12 крит, +35% сила криту; 6 р. — +139 flat; 20 р. — +609 flat.',
};
